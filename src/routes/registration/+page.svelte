...
<main class="container2">
  <section class="reg">
    <h2>Ресторан "Полёт ласточки"</h2>
    <p class="reg-description">Регистрация</p>
    <form class="reg-form">
      <p>
      ...
      <p>
        ...
        <input id="user-number" type="tel" name="number" />
      </p>
      <p>
      ...
      <p>
        ...
        >
        <input id="user-birthdate" type="date" name="birthdate" />
      </p>
      <p>
    ...
    <button class="button button-reg2" type="submit">Зарегистрироваться</button>
  </section>
</main>
